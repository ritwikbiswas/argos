...
def vision_kit_component():
    ...
    #Download csv files
    initial = 'sshpass -p "suripre225" scp pi@' + VISION_IP_ADDRESS_ + ':/home/pi/~/joy_detection_fire/'
...
def voice_kit_component():
    ...
    initial = 'sshpass -p "suripre225" scp pi@' + VOICE_IP_ADDRESS_ + ':/home/pi/~/joy_detection_voice/output/'
...
def write_to_file(all_data):
    ...
    f_data.write("time_stamp, elapsed_time, v_neutral, v_happy, v_sad, v_angry, v_fear, s_neg, s_neutral, s_pos, s_compound\n")
